...
export const BentoGridItem = ({
  ...
  const leftLists = ["JavaScript", "React.js", "Typescript"];
  const rightLists = ["Tailwind", "Node.js", "MongoDB"];
  ...
  */
  ...
  const handleCopy = () => {
    const text = "k.spinks07@gmail.com";
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-2">
              ...
              <div className='flex justify-center items-center md:gap-3 gap-6 mt-4'>
